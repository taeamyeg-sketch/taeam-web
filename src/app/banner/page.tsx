  ...
  return (
    <main className="fixed inset-0 w-full h-full bg-gold-bright overflow-hidden font-sans select-none">
      ...
      <div className="absolute left-[8%] sm:left-[10%] md:left-[12%] top-[28%] sm:top-1/3 md:top-[30%] z-10">
        <h1 className="text-noir text-[11vw] sm:text-[12vw] md:text-[8vw] font-black tracking-tighter leading-none">
          TAEAM
        </h1>
        <p className="text-noir/70 text-xs sm:text-sm md:text-xl font-bold tracking-tight mt-1 sm:mt-2 uppercase">
          Taste The Trust
        </p>
      </div>
