    ...
    <LegalShell
      ...
      intro={
        <>
          ...
          tried to keep it short. The short version: we only collect what we
          need to run your account and get your food to you, we don&apos;t sell
          your data, and you can email us any time at <LegalMail /> to see,
          fix, or delete what we have on you.
        </>
      }
    >
      <LegalSection id="what-we-collect" title="What we collect">
        ...
        <p>
          ...
          don&apos;t track you when the app is closed.
        </p>
        <p>
          We also collect basic technical details like device type, OS version,
          app version and crash reports, so we can fix bugs.
        </p>
      </LegalSection>
      ...
      <LegalSection id="sharing" title="Who we share it with">
        <p>
          Restaurants get your name, order, and delivery instructions so they
          can prepare your food. Drivers get the delivery address and a way to
          reach you during the drop-off. Stripe processes the payment, and we
      ...
      <LegalSection id="security" title="How we keep it safe">
        <p>
          ...
          Passwords aren&apos;t stored, auth is handled by Supabase. Payment
          cards aren&apos;t stored either, Stripe holds those. Inside the
          company, only the people who need access to do their job have it.
        </p>
        <p>
          Nothing online is bulletproof. If something does go wrong with your
          data, we&apos;ll tell you.
        </p>
      </LegalSection>
      ...
      <LegalSection id="your-rights" title="Your rights">
        <p>
          ...
          also opt out of marketing messages without losing the account.
        </p>
        <p>
      ...
      <LegalSection id="kids" title="Kids">
        <p>
          Taeam isn&apos;t for anyone under 13. We don&apos;t knowingly collect
          data from kids that age. If you think a child has signed up, email us
